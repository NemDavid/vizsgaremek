...
describe("/api/advertisement", () => {
    ...
    const rawAdvertisments = [
        {
            ...
            imagePath: "/advertisment_1.png",
        },
        {
            ID: 2,
            title: "test_title (2)",
            subject: "test_subject (2)",
            imagePath: "/advertisment_2.png",
        },
    ];
    ...
    describe("GET", () => {
        describe("GET /api/advertisement/all", () => {
            ...
            test("should throw ValidationError when token is invalide", async () => {
                const res = await request(app)
                    .get("/api/advertisement/all")
    ...
    describe("DELETE", () => {
        describe("DELETE /api/advertisement", () => {
            ...
            test.each([
                ...
                "should throw error when advertisments id is not valid",
                async (id, error) => {
                    const token = authUtils.generateUserToken(testUser);
                    const cookie = `user_token=${token}`;
                    await request(app)
    ...
    describe("POST", () => {
        describe("POST /api/advertisement", () => {
            test("should create new advertisment", async () => {
                ...
                const created = await db.Advertisement.findOne({
