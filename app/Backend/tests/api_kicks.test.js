            ...
            describe("GET /api/kicks", () => {
                    ...
                    test("should return all kicks from db", async () => {
                        ...
                        expect(res.body).toEqual(
                            expect.arrayContaining(
                                rawKicks.map(kick => expect.objectContaining({
                ...
                describe("GET /api/kicks/me", () => {
                    test("should return all kicks from db", async () => {
                        ...
                        const res = await request(app).get("/api/kicks/me").set("Cookie", [cookie]).expect(200);
                    ...
                    test("should throw error on invalid token", async () => {
                        ...
                        const res = await request(app).get("/api/kicks/me").set("Cookie", [cookie]).expect(400);
                ...
                describe("GET /api/kicks/all/sent", () => {
                    test("should return all sent kicks from loggen user", async () => {
                        ...
                        const res = await request(app).get("/api/kicks/all/sent").set("Cookie", [cookie]).expect(200);
                    ...
                    test("should throw error on invalid token", async () => {
                        ...
                        const res = await request(app).get("/api/kicks/all/sent").set("Cookie", [cookie]).expect(400);
                ...
                describe("GET /api/kicks/all/recieved", () => {
                    test("should return all recieved kicks for loggen user", async () => {
                        ...
                        const res = await request(app).get("/api/kicks/all/recieved").set("Cookie", [cookie]).expect(200);
                    ...
                    test("should throw error on invalid token", async () => {
                        ...
                        const res = await request(app).get("/api/kicks/all/recieved").set("Cookie", [cookie]).expect(400);
            ...
            describe("POST /api/kicks", () => {
                describe("POST /api/kicks/:userId", () => {
                    test("should create new kick", async () => {
                        ...
                        const res = await request(app).post(`/api/kicks/${userId}`).set("Cookie", [cookie]).expect(200);
                    ...
                    test("should throw error on invalid token", async () => {
                        ...
                        const res = await request(app).post(`/api/kicks/${userId}`).set("Cookie", [cookie]).expect(400);
